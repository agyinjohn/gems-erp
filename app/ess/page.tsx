                      ...
                      {!latestPayslip ? (
                        ...
                        <>
                          ...
                          <button
                            ...
                            onClick={() => { setSelectedSlip(latestPayslip); setShowFullSlip(true); }}
                          >
                            View full payslip
                          </button>
                        </>
                ...
                <div className="card">
                  <div className="flex items-center justify-between mb-5">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <button onClick={() => setShowFullSlip(true)} className="p-2 hover:bg-gray-100 rounded-lg text-gray-500" title="View full payslip">
                  ...
                  <button className="btn-primary w-full mt-4" onClick={() => setShowFullSlip(true)}>
                    <Eye className="w-4 h-4" /> View Full Payslip / Print
                  </button>
                </div>
              )}
            </div>
