  ...
  const printPayslip = (p: any) => {
    ...
    win.document.write(`
      ...
      <table>
        ...
        <tr><td class="label">Deductions</td><td class="amount" style="color:#dc2626">- GH₵ ${parseFloat(p.deductions||0).toFixed(2)}</td></tr>
                ...
                <>
                  ...
                  <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
                    ...
                    <div className="card bg-yellow-50">
                      <div className="text-xs text-gray-500 mb-1">Pending Leave</div>
                      <div className="text-xl font-extrabold text-gray-900">{pendingLeave}</div>
                    </div>
                    <div className="card bg-purple-50">
                      <div className="text-xs text-gray-500 mb-1">Approved Leave</div>
                      <div className="text-xl font-extrabold text-gray-900">{approvedLeave}</div>
                    </div>
                  </div>
                        ...
                        <>
                          ...
                          <div className="space-y-2">
                            {[
                              ...
                              { label:'Deductions',   val:`- GH₵ ${parseFloat(latestPayslip.deductions||0).toFixed(2)}`, color:'text-red-500' },
                            ].map(row => (
                ...
                <div className="card">
                  ...
                  <div className="border border-gray-100 rounded-xl overflow-hidden">
                    {[
                      ...
                      { label:'Deductions',    value: `- GH₵ ${parseFloat(selectedSlip.deductions||0).toFixed(2)}`, color:'text-red-600',   bg:'bg-red-50/40' },
                    ].map(row => (
