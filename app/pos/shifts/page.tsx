...
import { Clock, Search, Eye, Monitor, ChevronLeft, ChevronRight, Printer } from 'lucide-react';
    ...
    >
      <div className="space-y-6">
        <div className="flex flex-wrap items-center justify-between gap-3">
          <Link href="/pos" className="btn-secondary text-sm inline-flex items-center gap-1.5">
            <Monitor className="w-4 h-4" /> Back to POS
          </Link>
          <p className="text-sm text-gray-500">{total} shift{total === 1 ? '' : 's'} found</p>
        </div>
