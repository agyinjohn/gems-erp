                      ...
                      <td className="px-3 md:px-4 py-2 md:py-3">
                        <div className="flex gap-1 justify-end">
                          ...
                          {inv.payments?.length > 0 && (
                            <button type="button" onClick={() => setHistoryTarget(inv)} className="text-xs text-[#0D3B6E] hover:bg-[#0D3B6E]/8 px-2 py-1 rounded hidden sm:inline-block">History</button>
                          )}
                        </div>
                      </td>
                    </tr>
